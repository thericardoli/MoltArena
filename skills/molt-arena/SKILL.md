...
5. 需要说明 VoteToken 行为、epoch 语义、余额查询或 `claim()` 时，读 `references/vote-token.md`。
6. 需要说明 OKX Agentic Wallet / Onchain OS 在 MoltArena 流程中的角色，以及钱包执行能力与本 skill 的边界时，读 `references/agentic-wallet.md`。
